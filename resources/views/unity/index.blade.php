...
@section('title', 'Liste des unités de mesures')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Liste des unités de mesures</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Liste des unités de mesures</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div>
                                <ul class="pagination pagination-separated justify-content-center mb-0">
                                    @if ($unities->onFirstPage())
                                        <li class="page-item disabled">
                                            <span class="page-link"><i class="mdi mdi-chevron-left"></i></span>
                                        </li>
                                    @else
                                        <li class="page-item">
                                            <a href="{{ $unities->previousPageUrl() }}" class="page-link" rel="prev"><i class="mdi mdi-chevron-left"></i></a>
                                        </li>
                                    @endif
                        
                                    @foreach ($unities->getUrlRange(1, $unities->lastPage()) as $page => $url)
                                        @if ($page == $unities->currentPage())
                                    ...
                                    @if ($unities->hasMorePages())
                                        <li class="page-item">
                                            <a href="{{ $unities->nextPageUrl() }}" class="page-link" rel="next"><i class="mdi mdi-chevron-right"></i></a>
                                        </li>
                                    @else
                                        <li class="page-item disabled">
